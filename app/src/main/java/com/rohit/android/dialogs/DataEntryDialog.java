...
public class DataEntryDialog extends DialogFragment{
    ...
    // variable of rype DataEntryListner
    private DataEntryListner mlistner;
    ...
    public void onAttach(Context context) {
        ...
        // getting the mlistner reference using activity context.
        mlistner = (DataEntryListner) context;
    }
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // mehtod call to save data from dialog
               saveData();
            }
        });
    ...
    private void saveData() {
        ...
        // passing the object as a parameter to onDataEntryComplete
        mlistner.onDataEntryComplete(person);

        // Calling the dismiss method to close dialog.
        dismiss();
    }

// interface to pass the data from fragment to activity
    public interface DataEntryListner {

        // method with single parameter of type person
