...
public class MainActivity extends AppCompatActivity  implements DataEntryDialog.DataEntryListner{
    ...
    @Override
    // getting the data from the custom fragment.
    public void onDataEntryComplete(Person person) {
        Toast.makeText(this, person.getLastName(), Toast.LENGTH_SHORT).show();
